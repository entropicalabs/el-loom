...
Loom provides tools to easily design quantum error correction codes with high-level abstraction, and then to convert it to low-level quantum circuits that can be executed on various backends. And finally, Loom provides tools to analyze the performance of the quantum error correction codes. 
