...
class TestInterpreterRepetitionCode(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        # Repetition Code Blocks
        self.rep_code_1 = RepetitionCode.create(
            d=5,
            check_type="Z",
        ...
        self.rep_code_2 = RepetitionCode.create(
            d=5,
            check_type="Z",
            lattice=self.lattice,
            position=(20,),
    ...
    def test_run_interpreter_parallel_operations(self):
        ...
        self.assertEqual(len(new_step.final_circuit.circuit), 24)
