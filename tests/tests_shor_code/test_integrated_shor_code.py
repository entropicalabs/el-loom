...
# pylint: disable=duplicate-code
class TestInterpreterShorCode(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        # Shor Code Blocks
        self.shor_code_1 = ShorCode.create(
            lattice=self.lattice,
            position=(0,),
            unique_label="q1",
        )

        self.shor_code_2 = ShorCode.create(
            lattice=self.lattice,
            position=(20,),
            unique_label="q2",
        )
    ...
    def test_run_interpreter_parallel_operations(self):
        ...
        eka_w_ops = Eka(
            self.lattice,
            blocks=[self.shor_code_1, self.shor_code_2],
            operations=operations,
        )
